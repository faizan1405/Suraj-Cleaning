...
export default function Testimonials() {
  ...
  useEffect(() => {
    fetch("/api/admin/data/testimonials", { cache: "no-store" })
      ...
      <section id="testimonials" className="py-[72px] md:py-[88px] bg-[#f8fafc]">
        <div className="mx-auto max-w-[1260px] px-5 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white rounded-[20px] p-6 md:p-7 shadow-sm border border-slate-100 animate-pulse">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
          {testimonials.map((t, i) => (
            <motion.div
              ...
              className="bg-white rounded-[20px] p-6 md:p-7 shadow-sm border border-slate-100 flex flex-col card-lift"
            >
              {/* Quote */}
              <div className="mb-5">
                <motion.svg
              ...
              <div className="border-t border-slate-100 pt-4 mt-auto">
                <div className="flex items-center gap-3">
                  ...
                  <motion.div
                    ...
                    className="w-10 h-10 bg-[#2563eb] text-white rounded-full flex items-center justify-center text-[13px] font-bold shrink-0"
                  >
                    {t.initials}
                  </motion.div>
                  <div>
                ...
                <div className="flex items-center gap-3 mt-3">
                  ...
                  <span className="flex items-center gap-1 text-[12px] text-[#64748b]">
                    <svg viewBox="0 0 24 24" className="w-[14px] h-[14px]" aria-label="Google">
