...
const phone1 = contact.phoneRaw;
const phone2 = contact.phone2Raw;
const email = contact.email;
const supportWhatsAppMessage = social.supportWhatsAppMessage;
  ...
  return (
    <>
      ...
      <div className="hidden md:flex fixed bottom-6 right-6 z-40 flex-col gap-2.5">
        {/* WhatsApp */}
        <motion.a
          href={`https://wa.me/${phone1}?text=${encodeURIComponent(supportWhatsAppMessage)}`}
          target="_blank"
        ...
        <motion.a
          href={`tel:${phone1}`}
          aria-label="Call +91 98447 34939"
        ...
        <motion.a
          href={`tel:${phone2}`}
          aria-label="Call +91 82468 16784"
          className="group flex items-center gap-2.5 bg-[#1d4ed8] text-white pl-3 pr-4 py-2.5 rounded-full shadow-lg btn-shine"
          initial={{ opacity: 0, x: 40 }}
          animate={{ opacity: 1, x: 0 }}
